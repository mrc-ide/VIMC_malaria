...
This is a diagnostic report for VIMC outputs for `r site_name`, `r ur`. The EIR for this site is `r site$eir$eir[[1]]`. The description for this model run is `r description`. The scenario ran was `r scenario`. The population size of this model run was `r population`. The burn-in time was `r burnin` years. For this run, quick_run was `r quick_run` .
