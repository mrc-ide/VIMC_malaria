...
if(quick_run == T){
  population_diagnostic_model(processed_output, pg= 1, intro_yr = intro_yr, rows = 3, cols = 3)
...
if(quick_run == T){
 incident_cases_diagnostic(processed_output, pg= 1, intro_yr = intro_yr, rows= 3, cols= 3)
...
if(quick_run== T){
  incidence_rate_diagnostic(processed_output, pg= 1, intro_yr = intro_yr, rows= 3, cols= 3)
...
if(quick_run == T){
  mortality_diagnostic(processed_output, pg= 1, intro_yr = intro_yr, rows= , cols = 3)
...
if(quick_run== T){
  mortality_rate_diagnostic(processed_output, pg= 1, intro_yr = intro_yr, rows= 3, cols = 3)
...
if(quick_run == T){
  daly_diagnostic(processed_output, pg = 1, intro_yr = intro_yr, rows= 3, cols =3)
