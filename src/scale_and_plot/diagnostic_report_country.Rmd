...
parameter_draw<- descriptive_dt$parameter_draw
...
outcomes_averted<- input_data$outcomes_averted
site_data<- input_data$site_data
case_metrics<- input_data$case_metrics
...
Total cases in the country in WMR 2020 were `r format_number(case_metrics$cases_wmr_2020)`.
Total modelled cases in 2020 were `r format_number(case_metrics$cases_mod_2020)`.

Up to 2100, `r case_metrics$percent_cases_averted_2100` % of cases were averted by vaccine.
...
intvn_output<- processed_output[scenario == scenario]
baseline_output<- processed_output[scenario == 'no-vaccination']
